import { SiteConfig } from '../types/components'
...
export const defaultSEO = {
  ...
  description:
    'Community-driven equipment reviews by real players. Find the perfect blade, rubber, and setup for your playing style.',
