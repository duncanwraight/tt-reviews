    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-4">
          Start contributing to the community by submitting equipment or players.
        </p>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  <span className="text-lg">{getTypeIcon(submission.type)}</span>
                        ...
                        <h5 className="text-sm font-medium text-red-800">
                          ...
                          {submission.rejection_category && (
                            <span className="ml-2 text-xs font-normal">
                              ({getRejectionCategoryName(submission.rejection_category)})
                            </span>
                          )}
                        </h5>
                        <SafeHtml 
