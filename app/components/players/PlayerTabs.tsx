    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="card bg-white rounded-lg p-6 border border-gray-200">
          <h3 className="text-xl font-semibold text-gray-900 mb-3">Training Videos</h3>
          <p className="text-gray-600">Professional training footage and technique analysis</p>
        </div>
        <div className="card bg-white rounded-lg p-6 border border-gray-200">
          <h3 className="text-xl font-semibold text-gray-900 mb-3">Match Highlights</h3>
          <p className="text-gray-600">Tournament matches and competitive play</p>
        </div>
      </div>
    </div>
  );
...
export function PlayerTabs({ player, equipmentSetups, showEditButtons = false }: PlayerTabsProps) {
