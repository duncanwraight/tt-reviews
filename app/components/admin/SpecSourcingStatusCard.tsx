...
// timestamp. Read-only — the cron is the only producer; failures
// alert via Discord through the standard installAlerter path.
export function SpecSourcingStatusCard({
  status,
}: SpecSourcingStatusCardProps) {
  return (
    <div
      className="block bg-white rounded-lg shadow border border-gray-200 p-5"
