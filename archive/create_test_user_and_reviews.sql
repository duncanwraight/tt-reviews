-- Create test user and reviews for moderation testing
...
-- Get equipment ID and insert test reviews
DO $$
DECLARE
    equipment_uuid UUID;
    test_user_id UUID := '12345678-1234-1234-1234-123456789012';
BEGIN
    -- Get first equipment ID or create one
    ...
    -- Insert test reviews with pending status for moderation
    ...
    RAISE NOTICE 'Created test user and 3 pending reviews for equipment: %', equipment_uuid;
