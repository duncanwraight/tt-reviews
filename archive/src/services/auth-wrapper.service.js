...
export class AuthWrapperService {
     ...
     */
    async validateTokenAndGetUser(token, supabase) {
     ...
     */
    async getAuthenticatedClient(c) {
 ...
 */
export function createAuthService(c) {
 ...
 */
export async function getAuthContext(c) {
 ...
 */
export async function getAuthenticatedClient(c) {
    const authService = createAuthService(c);
