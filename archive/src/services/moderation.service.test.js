...
describe('ModerationService', () => {
    ...
    describe('approveReview', () => {
        it('should handle first approval correctly', async () => {
            ...
            vi.spyOn(moderationService, 'logModerationAction').mockResolvedValue(undefined);
    ...
    describe('rejectReview', () => {
        it('should reject review successfully', async () => {
            ...
            vi.spyOn(moderationService, 'logModerationAction').mockResolvedValue(undefined);
            const result = await moderationService.rejectReview('review-123', 'moderator-1', 'Inappropriate content');
