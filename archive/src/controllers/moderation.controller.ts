...
export class ModerationController {
  ...
  static async getPendingEquipmentSubmissions(
    c: Context<BindingsEnv & { Variables: EnhancedAuthVariables }>
  ) {
    try {
      const authService = createAuthService(c)
  ...
  static async approveEquipmentSubmission(
    c: Context<BindingsEnv & { Variables: EnhancedAuthVariables }>
  ) {
    try {
      const authService = createAuthService(c)
  ...
  static async rejectEquipmentSubmission(
    c: Context<BindingsEnv & { Variables: EnhancedAuthVariables }>
  ) {
    try {
      const authService = createAuthService(c)
      ...
      const success = await moderationService.rejectEquipmentSubmission(
        submissionId,
        user.id,
        reason
      )
  ...
  static async getEquipmentSubmission(
    c: Context<BindingsEnv & { Variables: EnhancedAuthVariables }>
  ) {
    try {
      const authService = createAuthService(c)
