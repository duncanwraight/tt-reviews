...
export const PlayerSubmitPage = () => {
    const breadcrumbs = generateBreadcrumbs('/players/submit');
    return (_jsxs(Layout, { title: "Submit New Player - TT Reviews", description: "Submit a new professional table tennis player profile with their equipment setup and details.", children: [_jsx(Breadcrumb, { items: breadcrumbs }), _jsx("section", { class: "py-8", children: _jsxs("div", { class: "main-container", children: [_jsxs("div", { class: "page-header mb-8", children: [_jsx("h1", { class: "text-3xl font-bold text-gray-900 mb-4", children: "Submit New Player" }), _jsx("p", { class: "text-lg text-gray-600 max-w-3xl", children: "Help us grow our database by submitting a new professional table tennis player. Include their current equipment setup and any relevant details you know about their playing style and achievements." })] }), _jsxs("div", { class: "submission-guidelines bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8", children: [_jsx("h3", { class: "text-lg font-semibold text-blue-900 mb-3", children: "Submission Guidelines" }), _jsxs("ul", { class: "space-y-2 text-blue-800", children: [_jsxs("li", { class: "flex items-start", children: [_jsx("span", { class: "text-blue-600 mr-2", children: "\u2022" }), "Only submit professional or well-known competitive players"] }), _jsxs("li", { class: "flex items-start", children: [_jsx("span", { class: "text-blue-600 mr-2", children: "\u2022" }), "Equipment information should be verified with reliable sources"] }), _jsxs("li", { class: "flex items-start", children: [_jsx("span", { class: "text-blue-600 mr-2", children: "\u2022" }), "Include source URLs when possible (interviews, videos, official websites)"] }), _jsxs("li", { class: "flex items-start", children: [_jsx("span", { class: "text-blue-600 mr-2", children: "\u2022" }), "All submissions will be reviewed before being published"] })] })] }), _jsx(PlayerForm, {})] }) }), _jsx("script", { src: "/client/auth.js" }), _jsx("script", { src: "/client/forms.js" }), _jsx("script", { dangerouslySetInnerHTML: { __html: getModalScript() } }), _jsx("script", { dangerouslySetInnerHTML: { __html: addPlayerFormScript() } }), _jsx("script", { dangerouslySetInnerHTML: { __html: addAuthCheckScript() } })] }));
};
