...
export const EquipmentSubmitPage = ({ baseUrl, user, children }) => {
    return (_jsxs(Layout, { title: "Submit New Equipment | TT Reviews", description: "Submit new table tennis equipment to the database. Help grow our comprehensive equipment review platform.", children: [_jsx("div", { class: "container mx-auto px-4 py-8", children: _jsxs("div", { class: "max-w-4xl mx-auto", children: [_jsxs("div", { class: "text-center mb-8", children: [_jsx("h1", { class: "text-3xl font-bold text-gray-900 mb-4", children: "Submit New Equipment" }), _jsx("p", { class: "text-lg text-gray-600", children: "Help expand our equipment database by submitting new table tennis equipment." })] }), _jsx(EquipmentSubmissionForm, { baseUrl: baseUrl }), children] }) }), _jsx("script", { src: "/client/auth.js" }), _jsx("script", { src: "/client/forms.js" }), _jsx("script", { dangerouslySetInnerHTML: { __html: getModalScript() } }), _jsx("script", { dangerouslySetInnerHTML: { __html: addEquipmentFormScript() } }), _jsx("script", { dangerouslySetInnerHTML: { __html: addAuthCheckScript() } })] }));
};
