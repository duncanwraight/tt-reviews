...
import { requireAdmin } from '../middleware/auth-enhanced';
...
moderation.get('/equipment-submissions/pending', ModerationController.getPendingEquipmentSubmissions);
moderation.get('/equipment-submissions/:id', ModerationController.getEquipmentSubmission);
moderation.post('/equipment-submissions/:id/approve', ModerationController.approveEquipmentSubmission);
