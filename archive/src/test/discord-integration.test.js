...
describe('Discord Service Integration with Mocked Dependencies', () => {
    it('should handle equipment search with mocked Supabase', async () => {
        ...
        const service = new DiscordService(mockSupabase, {
            DISCORD_ALLOWED_ROLES: 'moderator',
            SITE_URL: 'https://tt-reviews.local',
        });
        const result = await service.searchEquipment('butterfly');
    ...
    it('should handle player search with mocked Supabase', async () => {
        ...
        const result = await service.searchPlayer('ma long');
    ...
    it('should handle empty search results', async () => {
        ...
        const result = await service.searchEquipment('nonexistent');
    ...
    it('should format Discord webhook notifications correctly', async () => {
        ...
        expect(globalThis.fetch).toHaveBeenCalledWith('https://discord.com/webhook', expect.objectContaining({
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        }));
