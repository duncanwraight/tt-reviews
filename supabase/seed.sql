...
-- TT-219: peak_world_rank + peak_rank_year are the typed peak fields.
-- TT-221: `player_kind` defaults to 'professional'; amateur rows use
-- peak_rating_value / peak_rating_year instead.
INSERT INTO players (name, slug, ittfid, peak_world_rank, peak_rank_year, active_years, active, birth_country, birth_year, represents, playing_style, gender) VALUES
('LIN Shidong', 'lin-shidong', 137237, 1, 2025, '2019-present', true, 'CHN', 2005, 'CHN', 'shakehand_attacker', 'M'),
('WANG Chuqin', 'wang-chuqin', 121558, 1, 2026, '2017-present', true, 'CHN', 2000, 'CHN', 'shakehand_attacker', 'M'),
('Hugo CALDERANO', 'hugo-calderano', 115641, 2, 2026, '2015-present', true, 'BRA', 1996, 'BRA', 'shakehand_attacker', 'M'),
('Tomokazu HARIMOTO', 'tomokazu-harimoto', 123980, 2, 2022, '2017-present', true, 'JPN', 2003, 'JPN', 'shakehand_attacker', 'M'),
('LIANG Jingkun', 'liang-jingkun', 119588, 2, 2024, '2016-present', true, 'CHN', 1996, 'CHN', 'shakehand_attacker', 'M'),
('Truls MOREGARD', 'truls-moregard', 122044, 2, 2026, '2018-present', true, 'SWE', 2002, 'SWE', 'shakehand_attacker', 'M'),
('Felix LEBRUN', 'felix-lebrun', 135977, 4, 2026, '2020-present', true, 'FRA', 2006, 'FRA', 'penhold_rpb', 'M'),
('XIANG Peng', 'xiang-peng', 135888, 8, 2025, '2018-present', true, 'CHN', 2003, 'CHN', 'shakehand_attacker', 'M'),
('Darko JORGIC', 'darko-jorgic', 118927, 6, 2022, '2016-present', true, 'SLO', 1998, 'SLO', 'shakehand_attacker', 'M'),
('LIN Yun-Ju', 'lin-yun-ju', 121582, 5, 2021, '2017-present', true, 'TPE', 2001, 'TPE', 'shakehand_attacker', 'M'),
('Alexis LEBRUN', 'alexis-lebrun', 132992, 8, 2025, '2020-present', true, 'FRA', 2003, 'FRA', 'shakehand_attacker', 'M'),
('Dang QIU', 'dang-qiu', 114715, 8, 2023, '2015-present', true, 'GER', 1996, 'GER', 'penhold_rpb', 'M'),
('Patrick FRANZISKA', 'patrick-franziska', 102832, 8, 2025, '2010-present', true, 'GER', 1992, 'GER', 'shakehand_attacker', 'M'),
('Anton KALLBERG', 'anton-kallberg', 116853, 12, 2024, '2016-present', true, 'SWE', 1997, 'SWE', 'shakehand_attacker', 'M'),
('Benedikt DUDA', 'benedikt-duda', 116620, 8, 2025, '2014-present', true, 'GER', 1994, 'GER', 'shakehand_attacker', 'M'),
('LIN Gaoyuan', 'lin-gaoyuan', 115910, 2, 2019, '2014-present', true, 'CHN', 1995, 'CHN', 'shakehand_attacker', 'M'),
('AN Jaehyun', 'an-jaehyun', 121514, 13, 2025, '2018-present', true, 'KOR', 1999, 'KOR', 'shakehand_attacker', 'M'),
('JANG Woojin', 'jang-woojin', 114936, 8, 2023, '2014-present', true, 'KOR', 1995, 'KOR', 'shakehand_attacker', 'M'),
('OH Junsung', 'oh-junsung', 135367, 15, 2025, '2017-present', true, 'KOR', 2006, 'KOR', 'shakehand_attacker', 'M'),
('Sora MATSUSHIMA', 'sora-matsushima', 135996, 7, 2026, '2019-present', true, 'JPN', 2007, 'JPN', 'shakehand_attacker', 'M'),
('Dimitrij OVTCHAROV', 'dimitrij-ovtcharov', 107028, 1, 2018, '2007-present', true, 'UKR', 1988, 'GER', 'shakehand_attacker', 'M'),
('Anders LIND', 'anders-lind', 115029, 14, 2025, '2016-present', true, 'DEN', 1998, 'DEN', 'shakehand_attacker', 'M'),
('Omar ASSAR', 'omar-assar', 100696, 13, 2024, '2012-present', true, 'EGY', 1991, 'EGY', 'shakehand_attacker', 'M'),
('Jonathan GROTH', 'jonathan-groth', 112409, 15, 2018, '2011-present', true, 'DEN', 1992, 'DEN', 'shakehand_attacker', 'M'),
('KAO Cheng-Jui', 'kao-cheng-jui', 132824, 21, 2025, '2018-present', true, 'TPE', 2004, 'TPE', 'shakehand_attacker', 'M'),
-- Top 25 Women's Singles from ITTF Rankings 2025 Week #24 (with playing styles)
('SUN Yingsha', 'sun-yingsha', 131163, 1, 2026, '2017-present', true, 'CHN', 2000, 'CHN', 'shakehand_attacker', 'F'),
('WANG Manyu', 'wang-manyu', 121411, 2, 2026, '2016-present', true, 'CHN', 1999, 'CHN', 'shakehand_attacker', 'F'),
('CHEN Xingtong', 'chen-xingtong', 121403, 3, 2026, '2015-present', true, 'CHN', 1997, 'CHN', 'shakehand_attacker', 'F'),
('WANG Yidi', 'wang-yidi', 124110, 2, 2024, '2016-present', true, 'CHN', 1997, 'CHN', 'shakehand_attacker', 'F'),
('KUAI Man', 'kuai-man', 135049, 3, 2026, '2018-present', true, 'CHN', 2004, 'CHN', 'shakehand_attacker', 'F'),
('Miwa HARIMOTO', 'miwa-harimoto', 136711, 3, 2026, '2018-present', true, 'JPN', 2008, 'JPN', 'shakehand_attacker', 'F'),
('Mima ITO', 'mima-ito', 117821, 2, 2021, '2014-present', true, 'JPN', 2000, 'JPN', 'short_pips_hitter', 'F'),
('Satsuki ODO', 'satsuki-odo', 133405, 7, 2025, '2019-present', true, 'JPN', 2004, 'JPN', 'shakehand_attacker', 'F'),
('Hina HAYATA', 'hina-hayata', 123672, 4, 2023, '2016-present', true, 'JPN', 2000, 'JPN', 'shakehand_attacker', 'F'),
('SHIN Yubin', 'shin-yubin', 123977, 7, 2024, '2019-present', true, 'KOR', 2004, 'KOR', 'shakehand_attacker', 'F'),
('CHENG I-Ching', 'cheng-i-ching', 110797, 5, 2017, '2017-present', true, 'TPE', 1992, 'TPE', 'shakehand_attacker', 'F'),
('Bernadette SZOCS', 'bernadette-szocs', 111012, 8, 2024, '2014-present', true, 'ROU', 1995, 'ROU', 'shakehand_attacker', 'F'),
('Honoka HASHIMOTO', 'honoka-hashimoto', 133000, 10, 2025, '2019-present', true, 'JPN', 1998, 'JPN', 'classical_defender', 'F'),
('Sofia POLCANOVA', 'sofia-polcanova', 107477, 10, 2022, '2015-present', true, 'AUT', 1994, 'AUT', 'shakehand_attacker', 'F'),
('QIAN Tianyi', 'qian-tianyi', 119797, 5, 2023, '2018-present', true, 'CHN', 2000, 'CHN', 'shakehand_attacker', 'F'),
('Bruna TAKAHASHI', 'bruna-takahashi', 121623, 16, 2025, '2016-present', true, 'BRA', 2000, 'BRA', 'shakehand_attacker', 'F'),
('Adriana DIAZ', 'adriana-diaz', 115009, 9, 2024, '2017-present', true, 'PUR', 2000, 'PUR', 'shakehand_attacker', 'F'),
('ZHU Yuling', 'zhu-yuling', 117332, 1, 2018, '2015-present', true, 'MAC', 1995, 'MAC', 'shakehand_attacker', 'F'),
('CHEN Yi', 'chen-yi', 132132, 6, 2026, '2018-present', true, 'CHN', 2004, 'CHN', 'shakehand_attacker', 'F'),
('SHI Xunyao', 'shi-xunyao', 123120, 11, 2025, '2019-present', true, 'CHN', 2001, 'CHN', 'shakehand_attacker', 'F'),
('Miu HIRANO', 'miu-hirano', 117820, 5, 2017, '2016-present', true, 'JPN', 2000, 'JPN', 'shakehand_attacker', 'F'),
('HE Zhuojia', 'he-zhuojia', 119730, 13, 2019, '2018-present', true, 'CHN', 1998, 'CHN', 'shakehand_attacker', 'F'),
('Prithika PAVADE', 'prithika-pavade', 131100, 18, 2024, '2019-present', true, 'FRA', 2004, 'FRA', 'shakehand_attacker', 'F'),
('Miyuu KIHARA', 'miyuu-kihara', 131036, 13, 2022, '2020-present', true, 'JPN', 2004, 'JPN', 'shakehand_attacker', 'F'),
('Hana GODA', 'hana-goda', 131335, 20, 2026, '2018-present', true, 'EGY', 2007, 'EGY', 'shakehand_attacker', 'F');
...
-- /admin/import-players (TT-201); the prod→local seed-data wrapper
-- (TT-167) is the canonical way to refresh this block. Pairs with
-- normalised webps under supabase/seed-images/.
...
-- =============================================================================
-- Sponge thickness backfill (TT-191)
-- =============================================================================
-- Hand-curated sponge_thickness arrays for the well-known rubbers, sourced
-- from manufacturer / authoritative retailer pages. Spec-sourcing pipeline
-- (TT-145) will eventually backfill the long tail; this gives the dropdown
-- usable data on day one for the rubbers reviewers actually pick.
--
-- Values are strings (the field_type is text_list) so "OX" and "max" are
-- preserved literally alongside numeric thicknesses. mm unit is implicit
-- and rendered at display time.

-- Butterfly Tenergy series: 1.7 / 1.9 / 2.1 mm
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.7", "1.9", "2.1"]}'::jsonb
WHERE slug IN (
...
-- Butterfly Dignics series: 1.7 / 1.9 / 2.1 mm
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.7", "1.9", "2.1"]}'::jsonb
WHERE slug IN (
...
-- DHS Hurricane 3 family: 2.0 / 2.1 / 2.15 / 2.2 mm (per product owner)
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["2.0", "2.1", "2.15", "2.2"]}'::jsonb
WHERE slug IN ('dhs-hurricane-3-h3', 'dhs-neo-hurricane-3');

-- Yasaka Rakza family: 1.8 / 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.8", "2.0", "max"]}'::jsonb
WHERE slug IN ('yasaka-rakza-7', 'yasaka-rakza-7-soft', 'yasaka-rakza-z');

-- Yasaka Mark V (legacy): 1.5 / 1.8 / 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.5", "1.8", "2.0", "max"]}'::jsonb
WHERE slug = 'yasaka-mark-v';

-- Butterfly Sriver family (legacy): 1.5 / 1.8 / 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.5", "1.8", "2.0", "max"]}'::jsonb
WHERE slug IN ('butterfly-sriver', 'butterfly-sriver-fx');

-- Andro Rasanter series: 1.7 / 2.0 / UltraMAX
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.7", "2.0", "UltraMAX"]}'::jsonb
WHERE slug IN (
  'andro-rasanter-r53',
  'andro-rasanter-c53',
  'andro-rasanter-c48',
...
-- Andro Rasant: 1.7 / 1.9 / 2.1 / max (legacy non-tensor variant)
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.7", "1.9", "2.1", "max"]}'::jsonb
WHERE slug = 'andro-rasant';

-- Tibhar Evolution series: 1.7 / 1.9 / 2.1
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.7", "1.9", "2.1"]}'::jsonb
WHERE slug IN ('tibhar-evolution-mx-p', 'tibhar-evolution-el-p');

-- Tibhar Hybrid K3 family: 1.9 / 2.1 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.9", "2.1", "max"]}'::jsonb
WHERE slug IN ('tibhar-hybrid-k3', 'tibhar-hybrid-k3-pro');

-- Xiom Omega VII / VIII / 8 family: 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["2.0", "max"]}'::jsonb
WHERE slug IN (
  'xiom-omega-vii-pro',
  'xiom-omega-vii-euro',
  'xiom-omega-vii-asia',
...
-- Xiom Vega family: 1.8 / 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.8", "2.0", "max"]}'::jsonb
WHERE slug IN (
  'xiom-vega-europe',
  'xiom-vega-pro',
  'xiom-vega-china-plus',
  'xiom-vega-pro-h',
  'xiom-vega-euro-h'
);

-- Donic Bluefire family: 1.8 / 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.8", "2.0", "max"]}'::jsonb
WHERE slug = 'donic-bluefire-m2';

-- Nittaku Fastarc G-1: 1.8 / 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.8", "2.0", "max"]}'::jsonb
WHERE slug = 'nittaku-fastarc-g1';

-- Stiga Mantra M: 1.8 / 2.0 / max
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["1.8", "2.0", "max"]}'::jsonb
WHERE slug = 'stiga-mantra-m';

-- Long pips (TSP / Tibhar Grass / Feint Long 3 / Victas Curl P1V):
-- OX / 0.5 / 1.0 / 1.5 — the standard long-pip set.
UPDATE equipment SET specifications = specifications || '{"sponge_thickness": ["OX", "0.5", "1.0", "1.5"]}'::jsonb
WHERE slug IN (
  'tsp-curl-p1r',
  'tibhar-grass-dtecs',
