...
INSERT INTO players (name, slug, ittfid, highest_rating, active_years, active, birth_country, birth_year, represents, playing_style, gender) VALUES
('LIN Shidong', 'lin-shidong', 137237, 'WR1 (2025)', '2019-present', true, 'CHN', 2005, 'CHN', 'shakehand_attacker', 'M'),
('WANG Chuqin', 'wang-chuqin', 121558, 'WR1 (2026)', '2017-present', true, 'CHN', 2000, 'CHN', 'shakehand_attacker', 'M'),
('Hugo CALDERANO', 'hugo-calderano', 115641, 'WR2 (2026)', '2015-present', true, 'BRA', 1996, 'BRA', 'shakehand_attacker', 'M'),
('Tomokazu HARIMOTO', 'tomokazu-harimoto', 123980, 'WR2 (2022)', '2017-present', true, 'JPN', 2003, 'JPN', 'shakehand_attacker', 'M'),
('LIANG Jingkun', 'liang-jingkun', 119588, 'WR2 (2024)', '2016-present', true, 'CHN', 1996, 'CHN', 'shakehand_attacker', 'M'),
('Truls MOREGARD', 'truls-moregard', 122044, 'WR2 (2026)', '2018-present', true, 'SWE', 2002, 'SWE', 'shakehand_attacker', 'M'),
('Felix LEBRUN', 'felix-lebrun', 135977, 'WR4 (2026)', '2020-present', true, 'FRA', 2006, 'FRA', 'penhold_rpb', 'M'),
('XIANG Peng', 'xiang-peng', 135888, 'WR8 (2025)', '2018-present', true, 'CHN', 2003, 'CHN', 'shakehand_attacker', 'M'),
('Darko JORGIC', 'darko-jorgic', 118927, 'WR6 (2022)', '2016-present', true, 'SLO', 1998, 'SLO', 'shakehand_attacker', 'M'),
('LIN Yun-Ju', 'lin-yun-ju', 121582, 'WR5 (2021)', '2017-present', true, 'TPE', 2001, 'TPE', 'shakehand_attacker', 'M'),
('Alexis LEBRUN', 'alexis-lebrun', 132992, 'WR8 (2025)', '2020-present', true, 'FRA', 2003, 'FRA', 'shakehand_attacker', 'M'),
('Dang QIU', 'dang-qiu', 114715, 'WR8 (2023)', '2015-present', true, 'GER', 1996, 'GER', 'penhold_rpb', 'M'),
('Patrick FRANZISKA', 'patrick-franziska', 102832, 'WR8 (2025)', '2010-present', true, 'GER', 1992, 'GER', 'shakehand_attacker', 'M'),
('Anton KALLBERG', 'anton-kallberg', 116853, 'WR12 (2024)', '2016-present', true, 'SWE', 1997, 'SWE', 'shakehand_attacker', 'M'),
('Benedikt DUDA', 'benedikt-duda', 116620, 'WR8 (2025)', '2014-present', true, 'GER', 1994, 'GER', 'shakehand_attacker', 'M'),
('LIN Gaoyuan', 'lin-gaoyuan', 115910, 'WR2 (2019)', '2014-present', true, 'CHN', 1995, 'CHN', 'shakehand_attacker', 'M'),
('AN Jaehyun', 'an-jaehyun', 121514, 'WR13 (2025)', '2018-present', true, 'KOR', 1999, 'KOR', 'shakehand_attacker', 'M'),
('JANG Woojin', 'jang-woojin', 114936, 'WR8 (2023)', '2014-present', true, 'KOR', 1995, 'KOR', 'shakehand_attacker', 'M'),
('OH Junsung', 'oh-junsung', 135367, 'WR15 (2025)', '2017-present', true, 'KOR', 2006, 'KOR', 'shakehand_attacker', 'M'),
('Sora MATSUSHIMA', 'sora-matsushima', 135996, 'WR7 (2026)', '2019-present', true, 'JPN', 2007, 'JPN', 'shakehand_attacker', 'M'),
('Dimitrij OVTCHAROV', 'dimitrij-ovtcharov', 107028, 'WR1 (2018)', '2007-present', true, 'UKR', 1988, 'GER', 'shakehand_attacker', 'M'),
('Anders LIND', 'anders-lind', 115029, 'WR14 (2025)', '2016-present', true, 'DEN', 1998, 'DEN', 'shakehand_attacker', 'M'),
('Omar ASSAR', 'omar-assar', 100696, 'WR13 (2024)', '2012-present', true, 'EGY', 1991, 'EGY', 'shakehand_attacker', 'M'),
('Jonathan GROTH', 'jonathan-groth', 112409, 'WR15 (2018)', '2011-present', true, 'DEN', 1992, 'DEN', 'shakehand_attacker', 'M'),
('KAO Cheng-Jui', 'kao-cheng-jui', 132824, 'WR21 (2025)', '2018-present', true, 'TPE', 2004, 'TPE', 'shakehand_attacker', 'M'),
-- Top 25 Women's Singles from ITTF Rankings 2025 Week #24 (with playing styles)
('SUN Yingsha', 'sun-yingsha', 131163, 'WR1 (2026)', '2017-present', true, 'CHN', 2000, 'CHN', 'shakehand_attacker', 'F'),
('WANG Manyu', 'wang-manyu', 121411, 'WR2 (2026)', '2016-present', true, 'CHN', 1999, 'CHN', 'shakehand_attacker', 'F'),
('CHEN Xingtong', 'chen-xingtong', 121403, 'WR3 (2026)', '2015-present', true, 'CHN', 1997, 'CHN', 'shakehand_attacker', 'F'),
('WANG Yidi', 'wang-yidi', 124110, 'WR2 (2024)', '2016-present', true, 'CHN', 1997, 'CHN', 'shakehand_attacker', 'F'),
('KUAI Man', 'kuai-man', 135049, 'WR3 (2026)', '2018-present', true, 'CHN', 2004, 'CHN', 'shakehand_attacker', 'F'),
('Miwa HARIMOTO', 'miwa-harimoto', 136711, 'WR3 (2026)', '2018-present', true, 'JPN', 2008, 'JPN', 'shakehand_attacker', 'F'),
('Mima ITO', 'mima-ito', 117821, 'WR2 (2021)', '2014-present', true, 'JPN', 2000, 'JPN', 'short_pips_hitter', 'F'),
('Satsuki ODO', 'satsuki-odo', 133405, 'WR7 (2025)', '2019-present', true, 'JPN', 2004, 'JPN', 'shakehand_attacker', 'F'),
('Hina HAYATA', 'hina-hayata', 123672, 'WR4 (2023)', '2016-present', true, 'JPN', 2000, 'JPN', 'shakehand_attacker', 'F'),
('SHIN Yubin', 'shin-yubin', 123977, 'WR7 (2024)', '2019-present', true, 'KOR', 2004, 'KOR', 'shakehand_attacker', 'F'),
('CHENG I-Ching', 'cheng-i-ching', 110797, 'WR5 (2017)', '2017-present', true, 'TPE', 1992, 'TPE', 'shakehand_attacker', 'F'),
('Bernadette SZOCS', 'bernadette-szocs', 111012, 'WR8 (2024)', '2014-present', true, 'ROU', 1995, 'ROU', 'shakehand_attacker', 'F'),
('Honoka HASHIMOTO', 'honoka-hashimoto', 133000, 'WR10 (2025)', '2019-present', true, 'JPN', 1998, 'JPN', 'classical_defender', 'F'),
('Sofia POLCANOVA', 'sofia-polcanova', 107477, 'WR10 (2022)', '2015-present', true, 'AUT', 1994, 'AUT', 'shakehand_attacker', 'F'),
('QIAN Tianyi', 'qian-tianyi', 119797, 'WR5 (2023)', '2018-present', true, 'CHN', 2000, 'CHN', 'shakehand_attacker', 'F'),
('Bruna TAKAHASHI', 'bruna-takahashi', 121623, 'WR16 (2025)', '2016-present', true, 'BRA', 2000, 'BRA', 'shakehand_attacker', 'F'),
('Adriana DIAZ', 'adriana-diaz', 115009, 'WR9 (2024)', '2017-present', true, 'PUR', 2000, 'PUR', 'shakehand_attacker', 'F'),
('ZHU Yuling', 'zhu-yuling', 117332, 'WR1 (2018)', '2015-present', true, 'MAC', 1995, 'MAC', 'shakehand_attacker', 'F'),
('CHEN Yi', 'chen-yi', 132132, 'WR6 (2026)', '2018-present', true, 'CHN', 2004, 'CHN', 'shakehand_attacker', 'F'),
('SHI Xunyao', 'shi-xunyao', 123120, 'WR11 (2025)', '2019-present', true, 'CHN', 2001, 'CHN', 'shakehand_attacker', 'F'),
('Miu HIRANO', 'miu-hirano', 117820, 'WR5 (2017)', '2016-present', true, 'JPN', 2000, 'JPN', 'shakehand_attacker', 'F'),
('HE Zhuojia', 'he-zhuojia', 119730, 'WR13 (2019)', '2018-present', true, 'CHN', 1998, 'CHN', 'shakehand_attacker', 'F'),
('Prithika PAVADE', 'prithika-pavade', 131100, 'WR18 (2024)', '2019-present', true, 'FRA', 2004, 'FRA', 'shakehand_attacker', 'F'),
('Miyuu KIHARA', 'miyuu-kihara', 131036, 'WR13 (2022)', '2020-present', true, 'JPN', 2004, 'JPN', 'shakehand_attacker', 'F'),
('Hana GODA', 'hana-goda', 131335, 'WR20 (2026)', '2018-present', true, 'EGY', 2007, 'EGY', 'shakehand_attacker', 'F');
...
INSERT INTO players (name, slug, ittfid, highest_rating, active_years, active, birth_country, birth_year, represents, playing_style, gender) VALUES
('Ma Long', 'ma-long', 105649, 'WR1 (2017)', '2003-2024', false, 'CHN', 1988, 'CHN', 'shakehand_attacker', 'M'),
('Vladimír Sámsonov', 'vladimir-samsonov', 108246, 'WR2 (2001)', '1995-2024', false, 'BLR', 1976, 'BLR', 'shakehand_attacker', 'M');
